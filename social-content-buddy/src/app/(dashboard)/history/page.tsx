    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/create">
            <Button className="bg-violet-600 hover:bg-violet-700 text-white gap-2 rounded-xl font-semibold cursor-pointer">
              ...
              <div key={batch.id} className="grid grid-cols-1 md:grid-cols-[2fr_80px_120px_120px_60px] gap-4 items-center px-5 py-4 hover:bg-slate-50 transition-colors">
                ...
                <div className="flex justify-end">
                  <Link href={`/history/${batch.id}`}>
                    <Button variant="ghost" size="sm" className="h-8 px-3 text-xs text-violet-600 hover:text-violet-700 hover:bg-violet-50 rounded-lg gap-1 cursor-pointer">View</Button>
                  </Link>
                </div>
              </div>
            ))}
