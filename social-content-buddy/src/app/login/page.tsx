...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      {/* Background glow */}
      <div className="absolute -top-48 -right-48 w-96 h-96 bg-violet-200/40 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="w-full max-w-[400px] relative">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm">
          <div className="mb-6 text-center">
            ...
            <p className="text-slate-500 text-sm mt-1">Enter your credentials to continue to your dashboard</p>
          </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  required
                  autoComplete="email"
                  className="bg-white border-slate-300 text-slate-900 placeholder:text-slate-400 focus-visible:ring-violet-500/20 focus-visible:border-violet-500 h-10 rounded-xl pl-10"
                />
              </div>
            </div>
        ...
        <p className="text-center text-slate-500 text-sm mt-6">
          ...
          <Link href="/signup" className="text-violet-600 hover:text-violet-700 font-medium transition-colors">
            Sign up
          </Link>
        </p>
      </div>
      ...
      <p className="absolute bottom-6 text-xs text-slate-400">
        &copy; {new Date().getFullYear()} PostAI Inc. All rights reserved.
      </p>
    </div>
  );
}
