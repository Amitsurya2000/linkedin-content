  ...
  return (
    <div className="bg-[#1e1e1e] rounded-xl border border-[#333] overflow-hidden max-w-[550px] w-full">
      ...
      <div className="p-4 flex items-start gap-3">
        ...
        <div className="w-12 h-12 rounded-full bg-[#0A66C2] flex items-center justify-center text-[#1A1414] font-bold text-sm shrink-0">
          {initials}
        </div>
        <div className="flex-1 min-w-0">
          <p className="text-[#1A1414] font-semibold text-sm">{name}</p>
      ...
      <div className="px-4 pb-3">
        ...
        <p className="text-[#1A1414] font-semibold text-[15px] leading-relaxed whitespace-pre-line mb-1">
          {hook}
        </p>
