...
export function SwipeDeck({
  ...
  const arrowCls =
    "absolute top-1/2 -translate-y-1/2 z-10 w-8 h-8 rounded-full bg-white/85 backdrop-blur border border-[#F2DAD8] shadow-lg flex items-center justify-center text-[#1A1414] hover:bg-white hover:border-[#ED383B] disabled:opacity-0 disabled:pointer-events-none transition-all";
          ...
          {slides.map((_, i) => (
            <button
              ...
              className={`h-1.5 rounded-full transition-all ${
                i === index ? "w-4 bg-[#ED383B]" : "w-1.5 bg-[#FAE8E6] hover:bg-[#ED383B]/50"
              }`}
            />
          ))}
        </div>
