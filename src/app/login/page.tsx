...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FCEBEC] flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-[400px] relative">
        ...
        <div className="bg-[#FFFFFF] border border-[#F5C5C7] rounded-2xl p-8 shadow-xl">
          <div className="mb-6 text-center">
            ...
            <p className="text-[#94a3b8] text-sm mt-1">Enter your credentials to continue</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <Label htmlFor="email" className="text-sm text-[#94a3b8] font-medium">
                Email
              </Label>
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                <Label htmlFor="password" className="text-sm text-[#94a3b8] font-medium">
                  Password
                </Label>
                <span className="text-xs text-[#ED383B] hover:text-[#DB272A] cursor-pointer font-medium">
                  Forgot password?
                </span>
              </div>
              <div className="relative">
        ...
        <p className="text-center text-[#94a3b8] text-sm mt-6">
          ...
          <Link href="/signup" className="text-[#ED383B] hover:text-[#DB272A] font-medium transition-colors">
            Sign up
          </Link>
        </p>
      </div>
      ...
      {/* Footer */}
      <p className="absolute bottom-6 text-xs text-[#64748b]">
