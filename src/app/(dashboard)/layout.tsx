...
export default async function DashboardLayout({
  ...
  return (
    <div className="flex h-screen bg-[#0f172a] overflow-hidden">
      {/* Sidebar */}
      <aside className="w-64 shrink-0 flex flex-col bg-[#1e293b] border-r border-[#334155]">
        {/* Logo */}
        ...
        {/* Bottom section */}
        <div className="mt-auto border-t border-[#334155] p-4 space-y-3">
          {/* User row */}
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center gap-3 px-3 py-2 rounded-xl text-[#94a3b8] hover:text-red-400 hover:bg-red-500/10 transition-all duration-150 text-sm font-medium cursor-pointer"
            >
