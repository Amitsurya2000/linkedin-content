...
function PostMini({
  ...
  return (
    ...
    >
      ...
      <span className="text-xs text-slate-700 truncate flex-1 group-hover:text-red-700">
        {post.hook || "Untitled"}
      </span>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40" onClick={onClose}>
      ...
      >
        ...
        <div className="p-5 space-y-4">
          ...
          {(post.approvalStatus === "approved" || post.approvalStatus === "scheduled") && (
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="text-xs px-2.5 py-1.5 rounded-lg border border-slate-200 bg-white text-slate-700 focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:border-red-300"
              />
              <input
                type="time"
                value={scheduleTime}
            ...
            {editingField === "hookCategory" ? (
              <div className="flex gap-2 mt-1">
                <input
                  ...
                  className="flex-1 text-sm px-3 py-1.5 rounded-lg border border-red-300 bg-white text-slate-900 focus:outline-none focus:ring-2 focus:ring-red-500/20"
                  autoFocus
                />
                <button
          ...
          {/* Hook */}
          <div>
            <label className="text-xs text-slate-400 font-medium uppercase tracking-wider">Hook</label>
            {editingField === "hook" ? (
              <div className="mt-1 space-y-2">
                <textarea
                  ...
                  onChange={(e) => setEditValue(e.target.value)}
                  rows={3}
                  className="w-full text-sm px-3 py-2 rounded-lg border border-red-300 bg-white text-slate-900 focus:outline-none focus:ring-2 focus:ring-red-500/20 resize-none"
                  autoFocus
                />
              ...
              <div className="flex items-start gap-2 mt-1 group">
                ...
                <button
                  ...
                  className="opacity-0 group-hover:opacity-100 text-slate-400 hover:text-red-600 cursor-pointer transition-opacity mt-0.5 shrink-0"
                >
                  <Pencil className="w-3.5 h-3.5" />
                </button>
              </div>
          ...
          {/* Body */}
          <div>
            <label className="text-xs text-slate-400 font-medium uppercase tracking-wider">Post Body</label>
            {editingField === "body" ? (
              <div className="mt-1 space-y-2">
                <textarea
                  value={editValue}
            ...
            {editingField === "hashtags" ? (
              <div className="mt-1 space-y-2">
                <textarea
                  ...
                  className="w-full text-sm px-3 py-2 rounded-lg border border-red-300 bg-white text-slate-900 focus:outline-none focus:ring-2 focus:ring-red-500/20 resize-none font-mono"
                  autoFocus
                />
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            size="sm"
            onClick={goToday}
            className="rounded-xl text-sm border-slate-300 text-slate-700 hover:bg-red-50 hover:border-red-300 cursor-pointer"
          >
            Today
          </Button>
