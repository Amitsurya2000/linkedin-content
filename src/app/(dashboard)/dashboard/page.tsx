        ...
        <div className="space-y-3">
          ...
          <div className="rounded-2xl bg-[#FFFFFF] border border-[#F5C5C7] overflow-hidden">
            <div className="hidden md:grid grid-cols-[2fr_1fr_80px_120px_80px] gap-4 px-5 py-3 border-b border-[#F5C5C7] bg-[#FCEBEC]/50">
              ...
              <span className="text-xs font-medium text-[#64748b] uppercase tracking-wider">Date</span>
                ...
                >
                  ...
                  <div>
                    <Link href={`/history/${batch.id}`}>
                      <Button variant="ghost" size="sm" className="h-8 w-8 p-0 text-[#64748b] hover:text-[#ED383B] hover:bg-[#ED383B]/10 rounded-lg cursor-pointer">
